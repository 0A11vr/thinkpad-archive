...
static const char     *briucmd[]   = { "light", "-A", "5", NULL };
static const char     *bridcmd[]   = { "light", "-U", "5", NULL };
static const char     *volucmd[]   = { "pulsemixer", "--change-volume", "+5", NULL };
static const char     *voldcmd[]   = { "pulsemixer", "--change-volume", "-5", NULL };
static const char     *voltcmd[]   = { "pulsemixer", "--toggle-mute", NULL};
...
static key keys[] = {
    ...
    {  0   ,              XF86XK_MonBrightnessUp,    start, {.com = briucmd}},
    {  0   ,              XF86XK_MonBrightnessDown,  start, {.com = bridcmd}},
    {  0   ,              XF86XK_AudioRaiseVolume,   start, {.com = volucmd}},
    {  0   ,              XF86XK_AudioLowerVolume,   start, {.com = voldcmd}},
    {  0   ,              XF86XK_AudioMute,          start, {.com = voltcmd}},
